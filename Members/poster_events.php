  ...
  <?php
      ...
      if(empty($errors)==true) {
        ...
        foreach($_FILES['image']['name'] as $key=>$val)
       {
        ...
        $connect->query("insert into post (member_id,date_posted,post_content,post_title,post_image,topic,access,lat,lng,loc,pstatus_rnt) values('$id2','$date_posted','$post_content','$post_title','$data','$topic','Member','$lat','$lng','$address','PENDING')");
        if($topic=="EVENTS")
        {
